...
export const programs = [
    {
        ...
        icon: <SiOpenaigym/>,
        title: "JavaScript",
        info: "We scripts innovative software projects!",
        path: "/programs/111"
    },
    {
        id: 2,
        icon: <SiOpenaigym/>,
        title: "Python",
        info: "We offer scripting your Idea!",
        path: "/programs/222"
    },
    {
        id: 3,
    ...
    },
    {
        ...
        icon: <SiOpenaigym/>,
        title: "IQ Test",
        info: "We try to script the future!",
        path: "/programs/444"
    }
]
...
const Trainer1 = require('./images/quests.webp')
const Trainer2 = require('./images/quests.webp')
const Trainer3 = require('./images/quests.webp')
const Trainer4 = require('./images/quests.webp')
const Trainer5 = require('./images/quests.webp')
const Trainer6 = require('./images/quests.webp')
